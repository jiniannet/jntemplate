...
//            return gpf;
//        }
//        private GetPropertyOrFieldDelegate SaveGetPropertyOrFieldProxy(Type type, Object value, String propertyName)
//        {
...
//            string key = String.Concat("DynamicMethod.PropertyOrField.", type.FullName, ".", propertyName);
...
//            //var methodBldr = typeBldr.DefineProperty(propertyName,)
//            //IL构建底层细节
...
//        {
//            SaveGetPropertyOrFieldProxy(type, value, propertyName);
...
//        private DynamicMethodInfo SaveExcuteMethodProxy(Type type, MethodInfo mi)
//        {
//            Type objectType = typeof(Object);
//            Type[] parameterTypes = {
//                objectType,
...
//            string key = "DynamicFunction." + type.FullName + "." + mi.Name;
...
//            ILGenerator il = methodBldr.GetILGenerator();
//            il.DeclareLocal(type);//0
...
//            // System.Reflection.Emit.Lightweight / tests / DynamicMethodGetILGenerator.cs
